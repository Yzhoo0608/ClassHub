...
// Create 'classrooms' table for storing classroom schedule and availability
...
// Create 'bookings' table for storing classroom booking records
...
// Loop through each date, room, and time slot to auto-populate classrooms table
for ($date = $startDate; $date <= $endDate; $date += 86400) { // Loop through each day
...
// Insert user accounts into database
