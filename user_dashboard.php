...
<!-- Sidebar -->
<div class="sidebar">
    <div class="logo">ClassHub</div> <!-- Logo -->
    <b>Welcome</b>
    <br>
    <!-- Navigation to check classroom availability -->
    <div class="has-submenu <?= in_array($page, ['calendar_G1', 'calendar_G2', 'calendar_G3' ]) ? 'active' : '' ?>">
        ...
        <!-- Navigation to choose the classroom for check the classroom availability  -->
        <div class="submenu">
...
function toggleSubmenu(event) {
    ...
    parent.classList.toggle('active'); // Toggle class to show and hide submenu
}
</script>
